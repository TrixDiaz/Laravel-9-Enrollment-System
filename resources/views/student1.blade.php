...
<body>
    ...
    {{-- End add new Modal --}}
{{-- Start Add Regular Modal --}}
<div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Enroll Regular Student</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
    ...
    <div class="modal-body">
      ...
      <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="form-group">
          <label>Enroll To</label>
          <select name="enrollTo" id="enrollTo" class="form-control" >
          ...
          <div class="form-group">
          <label>School Last Attended</b></label>
          <input type="text" placeholder="School Last Attended" name="schoolLastAttended" class="form-control" id="schoolLastAttended" required>
          </div>
          <div class="form-group">
        <label>School Last Attended Address</label>
        <textarea type="text" placeholder="School Last Attended Address" class="form-control" name="schoolLastAttendedAddress" id="schoolLastAttendedAddress" required></textarea>
          </div>
          <div class="form-group">
            <label>Student Email</b></label>
            <input type="text" placeholder="Student Email" name="email" class="form-control" required>
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Edit Enrollment Form</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" placeholder="School Last Attended" class = "form-control" id = "schoolLastAttended" name="schoolLastAttended" required>
              </div>
              <div class="form-group">
            <label>School Last Attended Address</label>
            <textarea type="text" placeholder="School Last Attended Address" class = "form-control" id = "schoolLastAttendedAddress" name="schoolLastAttendedAddress"required></textarea>
              </div>
              <div class="form-group">
                <label>Student Email</b></label>
                <input type="text" placeholder="Student Email" name="email" id="email"class="form-control" required>
                </div>
              <div class="form-group">
                <label>Student Password</b></label>
                <input type="password" placeholder="Student Password" name="password" id="password"class="form-control" required>
                </div>
              <div class="form-group">
                <label>Student Type</label>
