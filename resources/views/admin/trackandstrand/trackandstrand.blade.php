...
<body>
   ...
   <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <form action="{{ url('/admin/trackandstrand') }}" method="post">
    {{@csrf_field()}}
    <div class="modal-body">
 
        <div class="form-group">
            <label>Track</label>
            <input type="text" name ="track" class="form-control"  placeholder="Track">
          </div>

          <div class="form-group">
            <label>Strand ID</label>
            <input type="text" name ="strandID" class="form-control"  placeholder="Strand ID">
          </div>

          <div class="form-group">
            <label>Strand Name</label>
            <input type="text" name ="strandName" class="form-control"  placeholder="Strand Name">
          </div>
    ...
    <form action="/admin/trackandstrand/" method="post" id="editForm">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <label>Strand ID</label>
                <input type="text" name ="strandID" id="strandID"class="form-control"  placeholder="Strand ID">
              </div>

              <div class="form-group">
                <label>Strand Name</label>
                <input type="text" name ="strandName" id="strandName"class="form-control"  placeholder="Strand Name">
              </div>
